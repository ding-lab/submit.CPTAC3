...
ALLCASES="/gscuser/mwyczalk/projects/CPTAC3/CPTAC3.catalog/CPTAC3.C325.cases.dat"
ALLBAMMAP="/gscuser/mwyczalk/projects/CPTAC3/CPTAC3.catalog/MGI.BamMap.dat"

MYCASES="dat.tmp/cases.LUAD.b56.dat"
MYBAMMAP="dat.tmp/MGI.BamMap.WXS.LUAD.b56.dat"
